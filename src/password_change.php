...
//echo $user_id; exit;    
$result = getsecurityAlert($user_id);
$result_data = mysqli_fetch_array($result);
if($result_data['Flag']==1){
    updateforgotpassword($user_id);
}else{
...
<!--            <img src="https://ci5.googleusercontent.com/proxy/eeKV_wRIn_9DTyRAlU6pFs2RWDlc4d2VPUVLRLgU3tHm7RxPLv_D_K0fgxrlGJyDUL9e8-e-wrWV01oj9ph41ldj7JDVE1JEvnE=s0-d-e1-ft#https://PMC Cloud.info/Resources/logo_txt_white.png" alt="" style="width:300px;height:auto" class="CToWUd a6T" tabindex="0">-->
      ...
      <tr>
        <td style="padding:20px 30px 40px 30px;line-height:1.8;text-align:center;color:#000;">
            <p>Your password hasbeen changed successfully. <br>Please <a href="'.$link.'" target="_blank" data-saferedirecturl="#">click here </a> for login.</p>
            <p></p>
        </td>
      </tr>
    </tbody>
...
?>
                <div class="group mb-15" >
                    <div class="item">
                        <label style="color: red">Don't reload or refresh the page.</label>
                    </div>
...
?>
                <div class="group mb-15" >
                    <div class="item">
                        <label style="color: red">Password already changed successfully.</label>
                    </div>

                </div>
                <div class="group mb-15" >
                    <div class="item">
                        <label>Please <a href="<?php echo __SITEPATH1; ?>login.php">click here</a> for login.</label>
                    </div>
