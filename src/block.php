...
@media only screen and (max-width: 600px) {
	...
	<body class="no-skin">
<?php include './topmenu_beforelogin.php'; ?>
...
<div class="main-content" style="padding: 0 8%">    
...
?>
    ...
    <tr>
      ...
      <td class="txtd"><b><a href="#<?php echo $receiver; ?>" class=""><?php echo $receiver; ?></a></b><span class="pull-right hidden-phone"><span data-c="1459718305" data-time="1490101310000"><?php echo $item['AMCValue']; ?> O9C</span></span><br>
      <div style="padding-bottom:30px;width:100%;text-align:right;clear:both"> <button class="btn btn-success cb"><span data-c="1459718305" data-time="1490101310000"><?php echo $item['AMCValue']; ?> O9C</span></button></div>
      </td>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">O9Coin</span>
							 &copy; 2017
						</span>
